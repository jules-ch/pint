...
class GenericMeasurementRegistry(GenericPlainRegistry):
...
class MeasurementRegistry(GenericMeasurementRegistry):
    Quantity = objects.MeasurementQuantity[Any]
    Unit = objects.MeasurementUnit
